...
import RepeatCustomersCard from './RepeatCustomersCard';
...
const Dashboard = () => {
    return (
        <div className="p-4">
            <h1 className="text-2xl font-bold mb-4 text-center flex flex-col items-center justify-center">Sales Analytics Dashboard</h1>
